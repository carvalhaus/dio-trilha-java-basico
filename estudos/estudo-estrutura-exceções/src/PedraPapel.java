...
// TODO: complete os espaços em branco com sua solução para o problema
    	for (int i = 0; i < N; i++) {
    		...
    		else if (jogador2.equalsIgnoreCase("papel")) System.out.println("Jogador 2 venceu");
    		else if (jogador1.equalsIgnoreCase("papel")) System.out.println("Jogador 1 venceu");
